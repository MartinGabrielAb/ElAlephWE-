    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>ElAleph</b></span>
        </a>
          ...
          <div class="navbar-custom-menu">
            {{-- <ul class="nav navbar-nav"> --}}
              ...
              <div class="btn-group bg-primary">
                ...
                <div class="dropdown-menu dropdown-menu-right btn-lg">
                  <a href="{{ route('logout') }}"
              ...
              {{-- <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu m-0 p-0" > --}}
                  ...
                  {{-- <li class="user-header">
                    ...
                    <p>
                      gabrielabad2005@gmail.com - Administrador
                    </p>
                  </li> --}}
                  
                  <!-- Menu Footer-->
                  {{-- <li class="user-footer m-0 p-0">
      ...
      {{-- <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019-2020. Abad Martín Gabriel.</strong> All rights reserved.
      </footer> --}}
    <!-- jQuery 2.1.4 -->
